...
namespace BudGET.MobileApp.Services
{
    public class BudgetDataService : BaseDataService, IBudgetDataService
    {
        ...
        //public async Task<BudgetDetailViewModel> GetBudgetById(Guid id)
        //{
        //    var selectedBudget = await _client.GetBudgetByIdAsync(id);
        //    var mappedBudget = _mapper.Map<BudgetDetailViewModel>(selectedBudget);
        //    return mappedBudget;
        //}
        ...
        public async Task<ApiResponse<Guid>> UpdateBudget(BudgetDetailViewModel BudgetDetailViewModel)
        {
            try
            {
