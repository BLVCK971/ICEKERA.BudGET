...
namespace BudGET.Persistence.Migrations
{
    ...
    [Migration("20230802215212_modifyofDepenses")]
    partial class modifyofDepenses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudGET.Domain.Entities.Depense", b =>
                {
                    ...
                    b.HasOne("BudGET.Domain.Entities.Compte", "CompteCredite")
                        .WithMany("Depenses")
                        .HasForeignKey("CompteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BudGET.Domain.Entities.Salaire", b =>
                {
                    b.HasOne("BudGET.Domain.Entities.Compte", "CompteDebite")
                        .WithMany("Salaires")
                        .HasForeignKey("CompteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompteDebite");
                });
